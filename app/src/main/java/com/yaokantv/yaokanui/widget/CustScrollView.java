...
public class CustScrollView extends ScrollView {
     ...
     */
    private int lastScrollY, downScrollY;
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            if (onScrollListener != null) {
                onScrollListener.onScroll(downScrollY, scrollY);
            }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (onScrollListener != null) {
            onScrollListener.onScroll(downScrollY,
...
//                Logger.e("jj", "矩形：" + inner.getLeft() + "," + inner.getTop()
//                        + "," + inner.getRight() + "," + inner.getBottom());
                    // 移动布局
...
//        Logger.e("jj", "回归：" + normal.left + "," + normal.top + "," + normal.right
//                + "," + normal.bottom);
...
//        Logger.e("jj", "scrolly=" + scrollY);
    ...
    public interface OnScrollListener {
         ...
         *            、
         */
        public void onScroll(int downScrollY, int scrollY);
    }
