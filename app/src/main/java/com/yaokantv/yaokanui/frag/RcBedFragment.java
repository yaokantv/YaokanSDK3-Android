...
public class RcBedFragment extends BaseRcFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.frg_rc_bed, null);
...
//        list.add(new BedMode(BedMode.MODE_YOGA, "瑜伽模式", MpeDataKey.YOGA.getKey()));
        ...
        list.add(new BedMode(BedMode.MODE_WAKE_UP, "叫醒模式", MpeDataKey.WAKEUP.getKey()));
            ...
            protected void convert(ViewHolder holder, BedMode bedMode, int position) {
                ...
                switch (bedMode.getMode()) {
                    ...
                    case BedMode.MODE_ARDER:
                        ...
                        break;
                    case BedMode.MODE_WAKE_UP:
                        holder.setImageResource(R.id.iv_tag, R.mipmap.ic_mpe_awake);
                        break;
                }
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            switch (v.getId()) {
                ...
                case R.id.ll_foot_down:
                    ...
                    break;
                case R.id.ll_haf_up:
                    m = MpeDataKey.BOTHRISE.getKey();
                    break;
                case R.id.ll_haf_down:
                    m = MpeDataKey.BOTHDROP.getKey();
                    break;
            }
            ...
            curKey = m;
            Logger.d("TTTTT", m + "  " + event.getAction() + System.currentTimeMillis());
