...
public class RcAudioFragment extends BaseRcFragment implements View.OnClickListener, View.OnLongClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.frg_rc_audio, null);
    ...
    public void setKeyBackground() {
        ...
        KeyBackground(powerOn, DVDRemoteControlDataKey.POWER.getKey(), map);
        KeyBackground(signal, DVDRemoteControlDataKey.SIGNAL.getKey(), map);
    ...
    private void setKey(int id) {
        if (id == R.id.pro_power_on) {
            ...
            key = DVDRemoteControlDataKey.SIGNAL.getKey();
